...
#define SWM_PINASSIGN7                (SWM_BASE + 0x01c)  /* Pin assign register 7 */
#define SWM_PINASSIGN8                (SWM_BASE + 0x020)  /* Pin assign register 8 */
#define SWM_PINASSIGN0_U0_TXD_SHIFT   (0)                 /* U0_TXD function assignment */
#define SWM_PINASSIGN0_I2C0_SDA_SHIFT (24)                /* I2C0_SDA function assignment */
#define SWM_PINASSIGN0_I2C0_SCL_SHIFT (0)                 /* I2C0_SCL function assignment */

#define SYSCON_BASE                   0x40048000             /* System configuration */
#define SYSCON_PRESETCTRL             (SYSCON_BASE + 0x004)  /* Peripheral reset control */
#define SYSCON_PRESETCTRL_UART0_SHIFT (3)
#define SYSCON_PRESETCTRL_I2C_SHIFT   (6)
...
#define SYSCON_SYSAHBCLKCTRL_I2C      (1 << 5)               /* Enables clock for I2C */
